...
exports.delay = exports.serialize_quads = exports.safeAppendFile = exports.getRelationQuads = exports.getMemberQuads = exports.ensure = exports.n3_escape = exports.addExtra = exports.addPrefix = exports.replPredicate = exports.SDSToTree = exports.addBucketBase = exports.createTreeRelation = exports.getValueByKeyForStringEnum = exports.WIN_RESERVE_REGEX = exports.WIN_SYMBOL_REGEX = exports.WIN_REGEX = exports.treeNodeID = exports.treeCollectionID = exports.isTreeCollection = exports.createDir = exports.isValidURL = exports.sparql_query = exports.isSPARQLEndpoint = exports.sparql_ask_query = exports.exists = exports.writerToFile = exports.extract_resource_from_uri = exports.get_resource_index = exports.unescape = exports.n3Escape = exports.escape = exports.invalidWINSYM = exports.invalidWINRes = exports.isInvalidWINFN = exports.remainingItemsCount = void 0;
 ...
 */
function remainingItemsCount(store, relation) {
    let count = 0;
...
exports.remainingItemsCount = remainingItemsCount;
/**
...
function getRelationBNs(config, quads) {
    return [...new Set(quads.filter(q => q.predicate.equals(types_1.TREE.terms.relation)).map(q => q.object.value))];
}
function getNodeRelQuad(config, quads) {
    return quads.filter(q => q.predicate.equals(types_1.TREE.terms.relation));
}
function getRelationQuads(config, quads, nodes, counter) {
    /** update counter */
    const parent_node = getNodeRelQuad(config, quads).map(q => q.subject.value)[0];
    ...
    return [...new Set([...quads.filter(q => rel_bns.includes(q.subject.value)), ...node_rel_quad])];
}
