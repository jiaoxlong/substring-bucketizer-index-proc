...
function sds_to_tree(configPath, reader, meta_reader, treeMemberOutputStream) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = (0, parseConfig_1.getConfig)(configPath);
        meta_reader
            .on('data', (quad) => __awaiter(this, void 0, void 0, function* () {
            console.log(quad);
        }))
            .on('end', () => {
        ...
        reader
            .on('data', (quads) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield treeMemberOutputStream.disconnect();
    });
}
...
function ingest(configPath, treeMemberInputStream) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        treeMemberInputStream
            .on('data', (quadString) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const b of buckets) {
                const out = path_1.default.join(out_dir, (0, utils_1.escape)((0, utils_1.extract_resource_from_uri)(b.value)) + '.ttl');
            ...
            const rel_quads = (0, utils_1.getRelationQuads)(config, quads, buckets, counter);
            /** write relation quads */
            if (rel_quads.length != 0) {
                for (const p of parent_buckets) {
                    const rel_out = path_1.default.join(out_dir, (0, utils_1.escape)((0, utils_1.extract_resource_from_uri)(p)) + '.ttl');
