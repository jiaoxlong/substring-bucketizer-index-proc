...
function doQuery(config, writer) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield writer.disconnect().then(() => { console.log('querySparql: writer stream is closed'); });
    });
}
/**
...
function ingest(configPath, treeMemberInputStream) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const materialize = (quadString) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (rel_quads.length != 0) {
                for (const p of parent_buckets) {
                    const rel_out = path_1.default.join(out_dir, (0, utils_1.winEscape)((0, utils_1.extract_resource_from_uri)(p)) + '.ttl');
